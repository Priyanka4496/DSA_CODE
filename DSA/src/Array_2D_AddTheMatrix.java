...
The first argument is the 2D integer array The second argument is the 2D integer array B
Output Format
...
public class Array_2D_AddTheMatrix {
    ...
    public static void main(String[] args) {
        ...
        int[][] output1 = addMatrices(input1, input2);
        ...
        int[][] output2 = addMatrices(input3, input4);
